                    ...
                    <form action="{{ route('grupos.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select 
                                ...
                                <option value="Activo" {{ old('estatus_grupo') == 'Activo' ? 'selected' : '' }}>Activo</option>
                                <option value="Inactivo" {{ old('estatus_grupo') == 'Inactivo' ? 'selected' : '' }}>Inactivo</option>
                                <option value="Cerrado" {{ old('estatus_grupo') == 'Cerrado' ? 'selected' : '' }}>Cerrado</option>
                            </select>
                            @error('estatus_grupo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
